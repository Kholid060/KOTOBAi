...
const UiTabsRoot = TabsPrimitive.Root;

const UiTabsList = forwardRef<
...
const UiTabsTrigger = forwardRef<
...
const UiTabsContent = forwardRef<
...
const UiTabs = Object.assign(UiTabsRoot, {
  List: UiTabsList,
  Trigger: UiTabsTrigger,
