...
const UiDropdownMenuRoot = DropdownMenuPrimitive.Root;
...
const UiDropdownMenu = Object.assign(UiDropdownMenuRoot, {
  Sub: UiDropdownMenuSub,
  Item: UiDropdownMenuItem,
  Label: UiDropdownMenuLabel,
  Group: UiDropdownMenuGroup,
  Portal: UiDropdownMenuPortal,
  Trigger: UiDropdownMenuTrigger,
  Content: UiDropdownMenuContent,
  Shortcut: UiDropdownMenuShortcut,
  RadioItem: UiDropdownMenuRadioItem,
  Separator: UiDropdownMenuSeparator,
  SubContent: UiDropdownMenuSubContent,
  SubTrigger: UiDropdownMenuSubTrigger,
  RadioGroup: UiDropdownMenuRadioGroup,
  CheckboxItem: UiDropdownMenuCheckboxItem,
});
